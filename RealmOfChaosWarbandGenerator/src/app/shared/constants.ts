...
export const PERSONAL_ATTRIBUTES: ChaosAttribute[] = [
  ...
  { rollNumber: 215, name: "Breathes Fire", fearPoints: 1, description: "", profileBonus: new ProfileBonus() },
  ...
  { rollNumber: 230, name: "Burning Body", fearPoints: 3, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 240, name: "Chaos Lord", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 250, name: "Chaos Spawn", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 260, name: "Chaos Were", fearPoints: 2, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 270, name: "Cloud of Flies", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 280, name: "Cloven Hooves", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 285, name: "Cowardice", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 290, name: "Crest", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 305, name: "Crossbreed", fearPoints: 1, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 315, name: "Crown of Flesh", fearPoints: 1, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 320, name: "Crystalline Body", fearPoints: 2, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 325, name: "Dimensional Instability", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 330, name: "Duplication", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 335, name: "Elastic Limbs", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 340, name: "Enormously Fat", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 345, name: "Enormous Noise", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { rollNumber: 355, name: "Evil Eye", fearPoints: 1, description: "", profileBonus: new ProfileBonus() },
