...
export const PERSONAL_ATTRIBUTES: ChaosAttribute[] = [
  { specialRules: [], rollNumber: 5, name: "Acid Excretion", fearPoints: 1, description: "Any creature in combat with the mutant suffers one S5 hit every turn it fails to hit the mutant. Non-magical weapons are destroyed on the first wounding blow. Non-magical armor and shields are destroyed after first armor save. The mutant may not wear non-magical armor or use non-magical weapons.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 10, name: "Additional Eye", fearPoints: 1, description: "", profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 15, name: "Agility", fearPoints: 0, description: "Initiative + 3", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  {
    specialRules: [], rollNumber: 20, name: "Albino", fearPoints: 0, description: "Reduce T by -0.5", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  {
    specialRules: [], rollNumber: 175, name: "Bestial Face", fearPoints: 1, description: "Roll D10 to determine face type: 1-2 = Face of beast of Patron (Khorne followers may choose Dog Face +1 Bite Attack), 3-9 = Goat face (+1 Gore Attack), 10 = Consult Extended Table (D20)", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  {
    specialRules: [], rollNumber: 190, name: "Bird's Feet", fearPoints: 0, description: "T +0.5. If the mutant can fly, it also gains +2 Claw Attacks if flying above opponent.", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  {
    specialRules: [], rollNumber: 200, name: "Blood Rage", fearPoints: 0, description: `Subject to frenzy when withing 12" of a wounded created, including itself. The frenzy lasts for 2D6 turns. If there are no enemies in sight the mutant will attach an ally unless it makes a successful Cool test. The mutant's T increases by one.`, profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 220, name: "Brightly Patterned Skin", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 225, name: "Bulging Eyes", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 230, name: "Burning Body", fearPoints: 3, description: "The mutant causes an additional S4 hit every time it strikes in combat. Opponents subtract 2 from hit rolls. When an opponent hits the mutant oon a D6 roll of 1-3 they take a S2 hit. The mutant can only carry magical equipment.", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 250, name: "Chaos Spawn", fearPoints: 0, description: "The mutant gains D6 Chaos Attributes and becomes a Chaos Spawn. The mutant is subject to Stupidity.This should be re-rolled if champion is being initially generated.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 260, name: "Chaos Were", fearPoints: 2, description: "Generate a random Chaos creature under 'Instant' Chaos Spawn, but only give it D6 attributes. The mutant is now subject to frenzy, and becomes this other creature when a frenzy test is failed. Can only wear Chaos Armor. Every time the mutant gains an attribute the were form gains another separately generated attribute.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 270, name: "Cloud of Flies", fearPoints: 0, description: "Opponents suffer -1 to hit in combat.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 280, name: "Cloven Hooves", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 285, name: "Cowardice", fearPoints: 0, description: "Cool is reduced by half. Must make a successful Cool test in order to Charge. Subject to fear of any attackers who outnumber it's unit or side. May not accept challenges.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 290, name: "Crest", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 305, name: "Crossbreed", fearPoints: 1, description: "Roll a D6 then D12 for creature to cross with. Roll a D6 for Head/Upper Body/Lower Body/Arms/Legs to determine body parts. The mutant's new profile is an average of it's old profile and the new creature profiles (Add together and divide by 2 and round to nearest whole/half number)", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 315, name: "Crown of Flesh", fearPoints: 1, description: "Roll a D8 to determin crown type.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 320, name: "Crystalline Body", fearPoints: 2, description: "Toughness becomes 6, but Wounds become 1. Neither attributes can be altered unless the mutant's crystal structure is altered.", profileBonus: new ProfileBonus() }, 
  { specialRules: [], rollNumber: 325, name: "Dimensional Instability", fearPoints: 0, description: "The mutant is subject to Instability.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 330, name: "Duplication", fearPoints: 0, description: "The mutant splits into two entirely separate but initially identical beings.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 335, name: "Elastic Limbs", fearPoints: 0, description: `The mutant can stretch it's limbs up to 1+D6". It can make hand-to-hand attacks at this distance. Opponents can only strike back after a successful initiative test. Non-Chaos Armor does not cover limbs when attacking at a distance.`, profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 340, name: "Enormously Fat", fearPoints: 0, description: "Movement is cut in half, T+1", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 365, name: "Extra Joints", fearPoints: 0, description: "Roll a D6 to determine affected area: 1-3=Arms(I+1), 4-5=Legs(M+1), 6=Arms and Legs(I+1, M+1)", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 370, name: "Extremely Thin", fearPoints: 0, description: "Divide T by 2", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 380, name: "Eyestalks", fearPoints: 1, description: "", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 390, name: "Fangs", fearPoints: 1, description: "Mutant gains a Bite Attack if it does not already have one", profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 395, name: "Fast", fearPoints: 0, description: "The mutant develops remarkable speed using it's feet, wheels, tentacles, hooves or other strange motive apparatus.", profileBonus: {
      movement: 3,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 410, name: "Featureless Face", fearPoints: 1, description: "", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 415, name: "Fits", fearPoints: 0, description: `Mutant suffers fits when within 12" of a creature it fears. On a D6 roll of 6 it can do nothing this turn. Fits last until a WP test is passed at the start of subsequent turns.`, profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 420, name: "Flaming Skull Face", fearPoints: 1, description: "Gore or Bite attacks cause an additional S1 hit.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 425, name: "Furry", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 440, name: "GM's Choice", fearPoints: 0, description: "Choose a fitting mutation", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 450, name: "Growth", fearPoints: 1, description: "The mutant grows D3+1 times its original size. X2 = M*1.5, S+2, T+1, W*1.5, I-1, FP+1. X3 = M*2, WS-1, S+3, T+2, W*2, I-3, FP+2, X2 = M*2.5, S+4, T+3, W*2.5, I-5, FP+3. Non-Chaos Armor must be discarded.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 455, name: "Headless", fearPoints: 1, description: "Non-Chaos Armor must be discarded.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 460, name: "Hideous Appearance", fearPoints: 10, description: "", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 465, name: "Hopper", fearPoints: 0, description: "Divide M by 3, rounding fractions to the nearest whole number.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 475, name: "Horns", fearPoints: 1, description: "+1 Gore Attack", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 480, name: "Horrible Stench", fearPoints: 0, description: `Stench has a range of D6". All living enemy creatures within range suffer -1 (or +1 where appropriate) to dice rolls. The stench persists even after mutant is killed. Friendly units get +2 to route tests.`, profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 485, name: "Huge Head", fearPoints: 1, description: "", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 495, name: "Hunchback", fearPoints: 1, description: "Non-Chaos Armor must be discarded.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 500, name: "Hypnotic Gaze", fearPoints: 0, description: `The mutant may fix it's gaze on one opponent withing 6". They may make a WP test to avoid eye contact, or they may do nothing. When the mutant's gaze is removed, they must pass a WP test to act normally again.`, profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 505, name: "Illusion of Normality", fearPoints: 1, description: "Mutant's fear points only come into play when engaged in hand-to-hand combat.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 510, name: "Invisibility", fearPoints: 2, description: "The mutant can become invisible at will. It must become visible to attack. It may strike an opponent in hand-to-hand then become invisible immediately. Opponent must pass I test to strike back or suffer -4 to hit.", profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 515, name: "Iron Hard Skin", fearPoints: 1, description: "+3 Armor Save ", profileBonus: new ProfileBonus()
  },
  { specialRules: [], rollNumber: 522, name: "Irrational Fear", fearPoints: 0, description: "Roll D6 to determine number of things feared, D6 to determine extent of fear, D100 to determine things feared.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 535, name: "Irrational Hatred", fearPoints: 0, description: "Use irrational fear chart to determine hatred", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 540, name: "Levitation", fearPoints: 0, description: "Mutant gains 2D10 Levitation Points. Gains 2 Fear Points while levatating.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 550, name: "Limb Loss", fearPoints: 0, description: "Roll D6 to determine limbs lost. 1: All Arms(No weapon or claw attacks, No shield), 2: All Legs(M0), 3-4: One Arm(), 5-6: One Leg(M*0.5)", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 560, name: "Limb Transference", fearPoints: 1, description: "Use chart to determine which parts are moved where.", profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 565, name: "Long Legs", fearPoints: 1, description: "M+1. Non-Chaos Armor must be discarded.", profileBonus: {
      movement: 1,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 580, name: "Long Spines", fearPoints: 1, description: "On a D6 roll of 1 the spines are also poisonous. The mutant may only wear Chaos Armor. Opponents must pass I test or take S1 (S2 if poisonous) hit from spines", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 585, name: "Mace Tail", fearPoints: 0, description: "Gains a Tail Attack if they do not already have one. Tail Attack gets S+1.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 590, name: "Magic Immune", fearPoints: 0, description: "Magic has no effect on the mutant. Magic weapons are treated as non-magical when attacking the mutant.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 595, name: "Magic Resistant", fearPoints: 0, description: "Magic saving throws get +2 bonus. Save can be made against magic that normally doesn't allow saves, although this save does not get +2 bonus.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 600, name: "Magician", fearPoints: 0, description: "Gain 1 magic level plus associated spells.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 605, name: "Mane of Hair", fearPoints: 0, description: "The mutant may shave it's mane so that it may wear a helmet.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 610, name: "Manic Fighter", fearPoints: 0, description: `Hates enemy units within 12". Never makes rout tests as a result of hand-to-hand combat.`, profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 615, name: "Manikin", fearPoints: 2, description: "", profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 620, name: "Massive Intellect", fearPoints: 0, description: "Int+2", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 640, name: "Metal Body", fearPoints: 3, description: "Divide WS and BS by two, S+3, T=7. Immune to fire-based and cold-based damage. Cannot be hit by non-magical weapons. Electic-based attacks cause double damage.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 645, name: "Mindless", fearPoints: 0, description: "Int=0. Can no longer used weapons or cast spells. Cannot be a unit or warband leader. Immune to psychological effects. A champion who becomes mindels automatically turns into a Chaos Spawn.", profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 655, name: "Moronic", fearPoints: 0, description: "Int-2. Must take Cl test before taking any action. If Int <= 4 it cannot use weapons.", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 680, name: "Multiplication", fearPoints: 0, description: `When within 12" of an enemy, a D6 roll of 6 caused the mutant to split into D6 fragments. FP+3 while split. S and W divided equally amongs fragments (with a min value of 1). Lasts for D6 turns, after which any surviving fragments recombine (mutant player chooses which fragment they combined to). As long as one fragment survives the mutant is restored to full size and health.`, profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 685, name: "One Eye", fearPoints: 0, description: "Divide BS by two", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 700, name: "Overgrown Body Part", fearPoints: 1, description: "Roll D6 to determine area affected, D3+1 to determine extent of change.", profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 705, name: "Pin Head", fearPoints: 1, description: "Subject to Stupidity. Can no longer make weapon attacks if Int <= 4. Must pass a Cool test to take any action.", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  {
    specialRules: [], rollNumber: 720, name: "Pointed Head", fearPoints: 0, description: "Int-1", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 730, name: "Powerful Legs", fearPoints: 0, description: `Mutant may use full movement value, then jump half it's movement in the same turn. Can jump of obstacles less than 2" high. Mutants with birds feet may mak claw attacks if leaping over opponents.`, profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 735, name: "Prehensile Tail", fearPoints: 0, description: "Mutant may carry an extra weapon or shield with tail. No mutant may carry more than two shields.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 745, name: "Pseudo-Daemonhood", fearPoints: 5, description: `Gains horns wings and tail. Horns grant Gore Attack +1 if it does not already have one. Roll to generate Flight Profile (Min Speed:2D4-2", Max Speed:4D6", Acc/Dec:2D4-1". Non-Chaos Armor must be discarded.`, profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 750, name: "Puny", fearPoints: 0, description: "Divide S and T by four, rounding down. Stats cannot be reduced to below 1.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 755, name: "Quadruped/Biped", fearPoints: 0, description: "Two of a bipedal mutant's arms become legs - or two of a quadraped's legs become arms. Increase/Decrease M by 2 depending on legs added/lost. Increase/Decrease Weapon Attacks depending on arms added/lost.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 760, name: "Rapid Regeneration", fearPoints: 0, description: "Mutant may regenerate at end of turn - even if dead. Roll 2D6, if either are 4+ regain all lost wounds. If roll fails, mutant cannot regenerate those wounds this battle.", profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 765, name: "Razor Sharp Claws", fearPoints: 0, description: "+1 Claw Attack made with S+1", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  {
    specialRules: [], rollNumber: 780, name: "Resilient", fearPoints: 0, description: "", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 825, name: "Siamese Twin", fearPoints: 1, description: "Roll D6: 1-3=Back to back, 4-6=Side by side. If one mutant is killed, both die. Fear points are combined. Movement is divided by two.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 830, name: "Silly Voice", fearPoints: -1, description: "", profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 835, name: "Silly Walk", fearPoints: -1, description: "", profileBonus: {
      movement: -1,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 850, name: "Spits Acid", fearPoints: 0, description: `May spit acid 5" instead of one of it's normal attacks. Use BS to hit with S3. Mutant may not bite and spit in the same turn.`, profileBonus: new ProfileBonus() },
  {
    specialRules: [], rollNumber: 855, name: "Strong", fearPoints: 0, description: "", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 3,
  ...
  {
    specialRules: [], rollNumber: 880, name: "Technology", fearPoints: 1, description: "Int+2. If WS or BS is zero, increase to 1. If Int <= 4 weapon must be activated by a rider or handler. Roll to determin technology type.", profileBonus: {
      movement: 0,
      weaponSkill: 0,
      ballisticSkill: 0,
      strength: 0,
  ...
  { specialRules: [], rollNumber: 895, name: "Temporal Instability", fearPoints: 0, description: "Roll D6: 1-4 Involuntary (Every turn D6 roll of 6 causes mutant to dissapear for D6 turns), 5-6 Voluntary (Every turn D6 roll of 6 causes mutant to dissapear for D6 turns. Mutant may increase/decrease die rolls by 1) ", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 920, name: "Tentacles", fearPoints: 1, description: "Roll D6: 1-3=One Arm, 4-5=D3 Arms, 6=All Arms. Tentacles can grip weapons as normal.", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 925, name: "Transparent Skin", fearPoints: 2, description: "", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 930, name: "Uncanny Resemblance", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 940, name: "Uncontrollable Flatulence", fearPoints: 0, description: `Roll D6 each turn. On 5-6 the mutant emits a cloud of gas D4" in diameter that lasts for D3 turns. Roll D6 to determine gas type: 1-2=Poison(T test, death), 3=Paralysing(T test, paralyzed), 4=Noxious(T test, S-1), 5=Oily Smoke(As Mystic Mist), 6=Crazy(T test, frenzy). Gas clouds move D6" in random direction.`, profileBonus: new ProfileBonus() },
  { specialRules: [], rollNumber: 945, name: "Vampire", fearPoints: 2, description: "Gains 4D6 Blood Points. Each turn on D6 roll of 3+ it must expend a blood point or remain immobile. If attacked while immobile, must spend 1 blood point to defend itself. Mutant dies if reduces to 0 blood points. Regains one blood point per wound it inflicts in hand-to-hand.", profileBonus: new ProfileBonus() },
  ...
  { specialRules: [], rollNumber: 1000, name: "Invent Your Own", fearPoints: 0, description: "", profileBonus: new ProfileBonus() },
];
...
export const WEAPON_TYPES: Weapon[] = [
  ...
  { name: "Short Bow", strength: 3, strengthBonus: 0, attackBonus: 0, initiativeBonus: 0, range: 16, armorPenetration: 0, cost: 1, specialRules: [] },
  { name: "Long Bow", strength: 3, strengthBonus: 0, attackBonus: 0, initiativeBonus: 0, range: 30, armorPenetration: 0, cost: 3, specialRules: [] },
  { name: "Crossbow", strength: 4, strengthBonus: 0, attackBonus: 0, initiativeBonus: 0, range: 30, armorPenetration: 0, cost: 3, specialRules: [] },
